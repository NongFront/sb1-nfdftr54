...
const D_finger = () => {
  ...
  const unstrummedStrings = new Set([6, 5]);
  ...
  const playSound = (soundNumber: number) => {
    ...
    const newAudio = new Audio(`/sounds/D_${soundNumber}.wav`);
    newAudio.play();
    setAudio(newAudio);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-900">D Chord Fingering</h1>
            <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 max-w-2xl mx-4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">How to Play D Chord</h2>
                <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Place your first finger (blue) on the 3rd string, 2nd fret</li>
                    <li>Place your third finger (red) on the 2nd string, 3rd fret</li>
                    <li>Place your second finger (green) on the 1st string, 2nd fret</li>
                    <li>Do not play the 6th and 5th strings</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Accidentally playing the 6th or 5th strings</li>
                    <li>Not pressing hard enough on the strings</li>
                    <li>Muting the open 4th string</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Focus on keeping the open string ringing clearly</li>
                  </ul>
                </div>
              </div>
