...
const C_finger = () => {
  ...
  // Define which strings should not be strummed (string numbers starting from 1)
  const unstrummedStrings = new Set([6]);
  ...
  const playSound = (soundNumber: number) => {
    if (unstrummedStrings.has(soundNumber)) return; // Don't play unstrummed strings
    
    if (audio) {
      audio.pause();
      audio.currentTime = 0;
    }
    const newAudio = new Audio(`/sounds/C_${soundNumber}.wav`);
    newAudio.play();
    setAudio(newAudio);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-900">C Chord Fingering</h1>
            <button
            ...
            <div className="relative w-full h-[400px] bg-gradient-to-r from-amber-100 to-amber-200 rounded-xl overflow-hidden">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-gray-200 to-gray-100 border-r-2 border-gray-400 flex flex-col justify-between py-4">
                {['E', 'A', 'D', 'G', 'B', 'e'].map((string, index) => (
                  ...
                  >
                    <span className="text-gray-800 font-medium text-sm">{string}</span>
                    {unstrummedStrings.has(6 - index) && (
              ...
              {[...Array(6)].map((_, index) => (
                <div
                  key={index}
                  className={`absolute left-12 right-0 h-[1px] ${
                    unstrummedStrings.has(6 - index) ? 'bg-gray-300' : 'bg-gray-600'
                  }`}
                  style={{
              ...
              <div
                ...
                style={{
                  left: `${((1 - 0.5) * (100 - 12)) / 5 + 12}%`,
                  top: `${(4 * 400) / 6 + 400 / 12}px`,
                  transform: 'translate(-50%, -50%)',
                }}
                onClick={() => playSound(2)}
              >
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 max-w-2xl mx-4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">How to Play C Chord</h2>
                <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Place your third (red) finger on the 5th string (A string), 3rd fret</li>
                    <li>Place your second (green) finger on the 4th string (D string), 2nd fret</li>
                    <li>Keep the 3rd string (G string) open</li>
                    <li>Place your first (blue) finger on the 2nd string (B string), 1st fret</li>
                    <li>Keep the 1st string (high E string) open</li>
                    <li>Do not play the 6th string (low E string)</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Accidentally playing the 6th string</li>
                    <li>Not pressing hard enough on the strings</li>
                    <li>Muting adjacent strings with your fingers</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Arch your fingers to avoid muting other strings</li>
                  </ul>
                </div>
              </div>
