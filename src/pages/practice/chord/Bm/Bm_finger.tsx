...
const Bm_finger = () => {
  ...
  const playSound = (soundNumber: number) => {
    ...
    const newAudio = new Audio(`/sounds/Bm_${soundNumber}.wav`);
    newAudio.play();
    setAudio(newAudio);
    ...
    <Layout>
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          >
            <Mic
              className={`h-5 w-5 mr-2 ${isMicActive ? 'animate-pulse' : ''}`}
            />
                ...
                {['E', 'A', 'D', 'G', 'B', 'e'].map((string, index) => (
                  ...
                  >
                    ...
                    {unstrummedStrings.has(6 - index) && (
                      <span className="absolute text-red-500 font-bold text-xl">
                        ×
                      </span>
                    )}
                  </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 max-w-2xl mx-4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">How to Play Bm Chord</h2>
                <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>
                      Place your third finger (red) on the 3rd string, 4th fret
                    </li>
                    <li>
                      Place your second finger (green) on the 2nd string, 2nd
                      and 3rd frets
                    </li>
                    <li>
                      Place your first finger (blue) on the 1st string, 2nd fret
                    </li>
                  </ul>
                </div>
