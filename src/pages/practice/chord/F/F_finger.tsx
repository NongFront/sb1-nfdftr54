...
const F_finger = () => {
  ...
  const unstrummedStrings = new Set([6, 1]);
  ...
  const playSound = (soundNumber: number) => {
    ...
    const newAudio = new Audio(`/sounds/F_${soundNumber}.wav`);
    newAudio.play();
    setAudio(newAudio);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-900">F Chord Fingering</h1>
            <button
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="relative w-full h-[400px] bg-gradient-to-r from-amber-100 to-amber-200 rounded-xl overflow-hidden">
                ...
                {['E', 'A', 'D', 'G', 'B', 'e'].map((string, index) => (
                  ...
                  >
                    ...
                    {unstrummedStrings.has(6 - index) && (
                      <span className="absolute text-red-500 font-bold text-xl">×</span>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div
                className="absolute w-7 h-7 rounded-full bg-yellow-500 text-white flex items-center justify-center font-bold text-lg cursor-pointer hover:scale-110 transition-transform"
                style={{
                  left: `${((3 - 0.5) * (100 - 12)) / 5 + 12}%`,
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 max-w-2xl mx-4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">How to Play F Chord</h2>
                <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Do not play the 6th string and 1st string</li>
                    <li>Place your third finger (red) on the 5th string, 3rd fret</li>
                    <li>Place your fourth finger (yellow) on the 4th string, 3rd fret</li>
                    <li>Place your second finger (green) on the 3rd string, 2nd fret</li>
                    <li>Place your first finger (blue) on the 2nd string, 1st fret</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Accidentally playing the 6th or 1st string</li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Focus on muting the unwanted strings</li>
                  </ul>
                </div>
              </div>
