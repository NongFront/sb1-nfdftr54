              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Keep all other strings open</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Not pressing hard enough</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Check each string individually for clarity</li>
                    <li>Keep your thumb centered on the back of the neck</li>
                    <li>Maintain relaxed hand position</li>
                  </ul>
                </div>
              </div>
