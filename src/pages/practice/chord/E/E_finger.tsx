...
const E_finger = () => {
  ...
  const playSound = (soundNumber: number) => {
    ...
    const newAudio = new Audio(`/sounds/E_${soundNumber}.wav`);
    newAudio.play();
    setAudio(newAudio);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-900">E Chord Fingering</h1>
            <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 max-w-2xl mx-4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">How to Play E Chord</h2>
                <button
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Keep the 6th string open</li>
                    <li>Place your second finger (green) on the 5th string, 2nd fret</li>
                    <li>Place your third finger (red) on the 4th string, 2nd fret</li>
